...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Scene_v2&box=-84.114598,35.363158,-84.202722,35.291293
...
-----------
  ...
  * Scene_v2 Height Map (ASTER 30m).png
  ...
  * Scene_v2 Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Scene_v2 Height Map (SRTM3 v4.1).png
  ...
  * Scene_v2 Height Map (SRTM30 Plus).png
  ...
  * Scene_v2 Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 346m (actual) is equal to 40m in
