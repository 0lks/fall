...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Cherokee+Heart&box=-84.061460,35.187318,-84.226334,35.052570
...
-----------
  ...
  * Cherokee Heart Height Map (ASTER 30m).png
  ...
  * Cherokee Heart Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Cherokee Heart Height Map (SRTM3 v4.1).png
  ...
  * Cherokee Heart Height Map (SRTM30 Plus).png
  ...
  * Cherokee Heart Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 384m (actual) is equal to 40m in
